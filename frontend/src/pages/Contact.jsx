        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="space-y-4 border-l border-stone-gray/20 pl-6">
              ...
              <p className="text-sm">
                Request access to our hidden showrooms or arrange for a
                tailoring master to visit your estate.
              </p>
              <a
                href="mailto:concierge@ethereal.test"
                className="inline-block mt-4 text-accent-neon uppercase tracking-widest text-xs font-bold hover:text-luxury-black transition-colors"
              >
                concierge@ethereal.test
              </a>
            </div>
            ...
            <div className="space-y-4 border-l border-stone-gray/20 pl-6">
              ...
              <p className="text-sm">
                Our senior styling operatives are available 24 hours a day via
                secure telecommunications.
              </p>
              <p className="mt-4 font-serif text-xl text-luxury-black">
                +1 (800) 555-ETHL
              </p>
            </div>
          </div>
          ...
          <div className="pt-12 text-center border-t border-stone-gray/20">
            <Link
              to="/collection"
              className="bg-luxury-black text-cloud-dancer px-10 py-5 font-sans font-bold uppercase tracking-widest text-[10px] hover:bg-accent-neon hover:text-luxury-black transition-all duration-500 rounded-sm inline-block"
            >
