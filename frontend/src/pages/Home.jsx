        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <p className="font-sans text-stone-gray text-lg leading-relaxed max-w-lg">
              Every seam is a statement. Every fabric is a narrative. Ethereal
              garments are designed to be the background noise to your most
              pivotal moments—quiet, resolute, and flawlessly executed.
            </p>
            <Link
              to="/collection"
              className="inline-block font-sans font-bold uppercase tracking-[0.4em] text-xs border-b-2 border-luxury-black pb-2 hover:text-accent-neon hover:border-accent-neon transition-all duration-300"
            >
        ...
        <div className="max-w-screen-2xl mx-auto">
          <header className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
            <div className="space-y-4">
              <span className="font-sans uppercase tracking-[0.5em] text-[10px] text-accent-neon">
                Curated Selection
              </span>
            ...
            <Link
              to="/collection"
              className="font-sans uppercase tracking-widest text-xs border border-stone-gray/30 px-8 py-4 hover:bg-luxury-black hover:text-cloud-dancer transition-all duration-500 rounded-sm shadow-sm backdrop-blur-md"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {featuredProducts.map((prod, index) => (
              ...
              >
                ...
                <h3 className="font-serif text-2xl mb-2 group-hover:text-accent-neon transition-colors">
                  {prod.title}
                </h3>
                <p className="font-sans text-[10px] uppercase tracking-widest font-bold text-stone-gray">
                  ${prod.basePrice}
                </p>
              </motion.div>
            ))}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 max-w-screen-2xl mx-auto">
          ...
          >
            ...
            <div className="absolute inset-0 bg-black/20 group-hover:bg-black/40 transition-all flex items-center justify-center">
              <h3 className="text-white font-serif text-5xl uppercase tracking-widest italic">
                Men
              </h3>
            </div>
          </Link>
          <Link
            ...
            className="relative aspect-[2/3] overflow-hidden group lg:mt-20"
          >
            <img
